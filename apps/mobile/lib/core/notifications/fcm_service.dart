...
class FcmService {
  ...
  Future<void> _handleForegroundMessage(RemoteMessage message) async {
    ...
    // Determinar cor e ícone pela severidade/tipo
  ...
  int _severityColor(String severity) {
    switch (severity) {
      case 'critical': return 0xFFEF4444;
      case 'high':     return 0xFFF97316;
      case 'medium':   return 0xFFEAB308;
  ...
  String _iconForType(String type) {
    switch (type) {
      case 'alert':               return '@drawable/ic_alert';
      case 'occurrence_update':   return '@drawable/ic_occurrence';
      case 'sla_breach':          return '@drawable/ic_warning';
      default:                    return '@drawable/ic_notification';
    }
  }
