...
class ApiClient {
  ...
  Map<String, dynamic> _asMap(dynamic data) {
    ...
    throw Exception('Response não é um Map válido: ${data.runtimeType}');
  }
  ...
  Future<Map<String, dynamic>> syncBatch(
    ...
    final res = await _dio.post('/occurrences/sync', data: {
      'items': items,
    });
  ...
  Future<void> updateFcmToken(String token, String action) async {
    await _dio.patch('/users/me/fcm-token', data: {
      'token': token,
      'action': action,
    });
  }
